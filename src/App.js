  ...
  return (
    <div className="App">
      ...
      <AddBar>
        ...
        {/* <AddBarDiv>
          <p>
            {current.format("YYYY")}년 {current.format("M")}월 /{" "}
            {current.endOf("month").format("D")}일이 마지막이고{" "}
            {current.endOf("month").format("d")}요일
          </p>
          <button
            onClick={() => {
              let sibal = current.add(1, "month");
